...
const TheodoLink = () => {
  return (
    <a
      ...
      target="_blank"
      className="focus:outline-none -ml-8 mt-1"
    >
        <svg fill="white" version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" height="80" width="200"
	 viewBox="0 0 200 200">
<polygon className="st0" points="3.2,7.6 15,7.6 15,44.6 24.2,44.6 24.2,7.6 36,7.6 36,0 3.2,0 "/>
<path className="st0" d="M60.3,11.4c-3.7,0-7.2,0.1-9.6,1.9V0h-8.8v44.8h8.8V26.2c0-5.8,1.5-7.2,7.3-7.2c6.6,0,7.2,1.3,7.2,6.9v18.9H74
	v-21c0-4.8-0.9-7.6-2.8-9.4C69.1,12.3,65.8,11.4,60.3,11.4z"/>
<path className="st0" d="M108.6,14.8c-2.4-2.4-6.1-3.4-13-3.4c-6.1,0-10.8,0.6-13.5,3.4c-2.7,2.8-3.1,7.5-3.1,13.6
...
<path className="st0" d="M147,14.8c-2.5-2.4-6.4-3.4-13.5-3.4s-10.9,1-13.5,3.4c-2.5,2.5-3.6,6.4-3.6,13.6c0,7.2,1,11.1,3.6,13.6
...
<path className="st0" d="M179.6,0v13.3h-0.3c-2.2-1.8-5.7-1.9-9.9-1.9c-11.7,0-15,3.7-15,16.9c0,6.1,0.6,10.9,3.3,13.8
...
<path className="st0" d="M222.3,14.8c-2.5-2.5-6.4-3.4-13.5-3.4s-10.9,1-13.5,3.4c-2.5,2.5-3.6,6.4-3.6,13.6c0,7.2,1,11.1,3.6,13.6
